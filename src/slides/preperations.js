...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Subtitle>Preperations</Subtitle>
    ...
    */}
    ...
    <B>
      <StyledList>
        <Fragment order={2}>
          <li class="no-border">
            <ImportantLink href="https://www.google.com/chrome/">
              Chrome
            </ImportantLink>
          </li>
        </Fragment>
        <Fragment order={3}>
          <li class="no-border">
            <ImportantLink href="http://git-scm.com/book/en/v2/Getting-Started-Installing-Git">
              git
            </ImportantLink>
          </li>
        </Fragment>
        <Fragment order={4}>
          <li class="no-border">
            <ImportantLink href="https://nodejs.org/en/download/package-manager/">
              Node.js + npm
            </ImportantLink>
          </li>
        </Fragment>
        <Fragment order={5}>
          <li class="no-border">
            <ImportantLink href="https://modv.js.org/guide/">
              modV
            </ImportantLink>
          </li>
        </Fragment>
