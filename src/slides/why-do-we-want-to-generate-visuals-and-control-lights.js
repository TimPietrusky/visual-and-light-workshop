...
const notes = (
  <Notes>
    <p>
      Why do we want to do this in the first place? Why are we here today? I can
      tell you why I'm doing this, so you get an idea on why this might be
      relevant to you.
    </p>
  </Notes>
)
...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Title>
        Why do we want to generate <RainbowText text="Visuals" /> &amp;
        control&nbsp;
        <RainbowText text="Lights" />?
      </Title>
