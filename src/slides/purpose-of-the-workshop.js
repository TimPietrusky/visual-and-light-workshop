...
const notes = (
  <Notes>
    <ul>
      <li>
        Get you up to speed in creating visuals that can be used to go along
        with music
      </li>
      <li>
        Control lights that usually come with visuals when you are in a venue or
        know people that are doing this for fun
      </li>
      <li>
        Get the tools out there, both modV and luminave have been used by a very
        small group of people over the last years and it would be super nice to
        get more users on board
      </li>
      <li>Recreate the following visuals:</li>
    </ul>
  </Notes>
)
...
export default (
  <Slide key={uuid()}>
    ...
    <A>
      <Title>Purpose of the Workshop</Title>
