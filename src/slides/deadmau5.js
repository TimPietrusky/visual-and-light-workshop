...
*/
export default (
  <Slide key={uuid()} background={`url("media/deadmau5.jpg")`}>
    {/*
        luminave={['green']}
      */}
    ...
    <A>
      <StyledFooter>
        <ImportantLink href="http://joshualaw88.blogspot.com/2011/05/deadmau5-led-concert-live-in-malaysia_21.html">
          joshualaw88.blogspot.com/2011/05/deadmau5-led-concert-live-in-malaysia_21.html
        </ImportantLink>
      </StyledFooter>
